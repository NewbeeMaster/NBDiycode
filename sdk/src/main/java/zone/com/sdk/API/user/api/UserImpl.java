...
public class UserImpl extends BaseImpl<UserService> implements UserAPI {
     ...
     */
    @Override
    public DialogCall<List<Topic>> getUserCollectionTopicList(@NonNull String login_name, @Nullable Integer offset,
                                                              @Nullable Integer limit) {
        return  dialogWrapper( mService.getUserCollectionTopicList(login_name, offset, limit));
    }
     ...
     */
    @Override
    public   DialogCall<List<Topic>> getUserCreateTopicList(@NonNull String login_name, @Nullable String order,
